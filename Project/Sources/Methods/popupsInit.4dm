...
C_COLLECTION:C1488($3; $values; $indices)  // entitiy selection where the data comes from
...
// Form[$formObjectProperty][$popupFormObjectName]:=New object("propertyNames"; $propertyNames; "values"; $values; "method"; $method)
...
If ($default#Null:C1517)
	...
	Else 
		// if look for ID, find the proper index
